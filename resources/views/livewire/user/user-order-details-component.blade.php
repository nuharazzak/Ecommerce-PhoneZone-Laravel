                    ...
                    <div class="panel-heading">
                               ...
                               <h3 class="box-title">Products Name</h3>
                                <ul class="products-cart">
                                    ...
                                    <li class="pr-cart-item">
                                        ...
                                        <div class="price-field produtc-price"><p class="price">LKR {{($item->price)}}</p></div>
                                        <div class="quantity">
                                            <h5>{{$item->quantity}}</h5>
                                        </div>
                                        <div class="price-field sub-total"><p class="price">LKR {{($item->price * $item->quantity)}}</p></div>
                        ...
                        <div class="summary">
                            <div class="order-summary">
                                ...
                                <p class="summary-info"><span class="title">Subtotal</span><b class="index">LKR {{$order->subtotal}}</b></p>
                                <p class="summary-info"><span class="title">Tax</span><b class="index">LKR {{$order->tax}}</b></p>
                                <p class="summary-info"><span class="title">Shipping</span><b class="index">Free Shipping</b></p>
                                <p class="summary-info"><span class="title">Total</span><b class="index">LKR {{$order->total}}</b></p>
                            </div>
                        </div>
                    </div>
                </div>
