                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="changePassword">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="password" placeholder="Current Password" class="form-control input-md" name="current-password" wire:model="current_password">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="password" placeholder="Confirm Password" class="form-control input-md" name="password-confirmation" wire:model="password_confirmation">
