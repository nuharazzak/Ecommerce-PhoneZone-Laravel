                    ...
                    <div class="wrap-product-detail">
                        ...
                        <div class="detail-info">
                            ...
                            @if($product->sale_price > 0)
                                <div class="wrap-price"><span class="product-price">LKR {{$product->sale_price}}</span>
                                    <del><span class="product-price regprice">LKR {{$product->reguler_price}}</span></del></div>
                            @else
                                <div class="wrap-price"><span class="product-price">LKR {{$product->reguler_price}}</span></div>
                            @endif
                            ...
                            <div class="wrap-butons">
                                <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->reguler_price}})">Add to Cart</a>
                                <!-- <div class="wrap-btn">
                                ...
                                <li class="product-item">
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span class="product-price">LKR {{$p_product->reguler_price}}</span></div>
                                        </div>
                                    </div>
                                </li>
                                @endforeach
                                ...
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{route('product.details',['slug'=>$r_product->slug])}}" title="{{$r_product->name}}">
                                            <figure><img src="{{asset('assets/images/products')}}/{{$r_product->image}}" width="214" height="214" alt="{{$r_product->image}}"></figure>
                                        </a>
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">LKR {{$r_product->reguler_price}}</span></div>
                                    </div>
                                </div>
                                @endforeach
                                 ...
                                 <div class="product product-style-2 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">LKR 25000.00</span></div>
                                    </div>
                                </div>
