        ...
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="billing-address">
                        ...
                        <p class="row-in-form">
                            ...
                            <input type="text" name="add" value="" placeholder="Your address" wire:model="line1">
                            @error('line1')<span class="text-danger">{{$message}}</span>@enderror
                        </p>
                        <p class="row-in-form">
                            <label for="add">Line2</label>
                            <input type="text" name="add" value="" placeholder="Your address" wire:model="line2">
            ...
            <div class="col-md-12">
                    ...
                    <div class="billing-address">
                        ...
                        <p class="row-in-form">
                            <label for="add">Line1</label>
                            <input type="text" name="add" value="" placeholder="Your address" wire:model="s_line1">
                            @error('s_line1')<span class="text-danger">{{$message}}</span>@enderror
                        </p>
                        <p class="row-in-form">
                            <label for="add">Line2</label>
                            <input type="text" name="add" value="" placeholder="Your address" wire:model="s_line2">
            ...
            @endif
                ...
                <div class="summary summary-checkout">
                    <div class="summary-item payment-method">
                        ...
                        <div class="choose-payment-methods">
                            ...
                            <!-- <label class="payment-method">
                                ...
                                <span class="payment-desc">You can make your payment with card...</span>
                            </label> -->
                            
                            <label class="payment-method">
                                <input name="payment-method" id="payment-method-paypal" value="directpay" type="radio" wire:model="paymentmode">
                                <span>DirectPay</span>
                                <span class="payment-desc">You can pay using DirectPay payment gateway</span>
                                <span class="payment-desc"><a href="directpay"><img src="http://127.0.0.1:8000/assets/images/directpay_logo.png" alt="mercado" width="100px"></a></span>
                            </label>
                            @error('paymentmode')<span class="text-danger">{{$message}}</span>@enderror
                        </div>
                        @if(Session::has('checkout'))
                            <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">LKR {{Session::get('checkout')['total']}}</span></p>
                        @endif
                    ...
                    <!-- <div class="summary-item shipping-method">
                        ...
                        <p class="summary-info"><span class="title">Fixed Rs.0</span></p>
