...
<body class="home-page home-01 ">
				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+123) 456 789" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: 077 5678908</a>
								</li>
							</ul>
						</div>
										...
										<li class="menu-item menu-item-has-children parent" >
											<a title="My Account" href="#">My Account({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
												<ul class="submenu curency" >
													...
													<li class="menu-item">
														<a title="Brand" href="{{route('admin.brands')}}">Brands</a>
													</li>
													<li class="menu-item">
													...
													<li class="menu-item">
														<a title="Requested Product" href="{{route('admin.productrequest')}}">Requested Product</a>
													</li>
													<li class="menu-item" >
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="index.html" class="link-to-home"><img src="{{asset('assets/images/phonezone-logo-01.jpg')}}" alt="mercado"></a>
						</div>
					...
					<ul>
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">Free On Order Over LKR100K</p>
							</div>
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">45, Main Street, Kattankudy, Sri Lanka</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">077 5678908 - 0718769023</p>
											</li>
											<li>
												<i class="fa fa-envelope" aria-hidden="true"></i>
												<p class="contact-txt">phonezone@gmail.com</p>
											</li>											
										</ul>
									</div>
								</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">077 5678908 - 0718769023</b>
									</div>
								</div>
							</div>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2022 PhoneZone. All rights reserved</p>
					</div>
	...
	<script src="https://cdn.tiny.cloud/1/b58b755rasktrlm1xcedg4fqx3926cezoj1up07ifdk2z7e6/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
